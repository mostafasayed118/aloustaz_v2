# Source Project Analyzer Script

Copy and run this Python script to analyze the source project at `D:\aloustaz`.

## Instructions

1. Save the script below as `analyze_source.py` in any directory
2. Run it with: `python analyze_source.py`
3. Copy the output and paste it back here

## Python Script

```python
"""
Source Project Analyzer for D:\aloustaz
This script scans the source project and extracts critical design files.
Run this script to gather theme, layout, and component information.
"""
...
1. **Scans the directory structure** - Shows the top 3 levels of your project
2. **Finds critical files** - Searches for theme, layout, styles, and config files
3. **Reads file contents** - Displays the content of each critical file found
4. **Lists all source files** - Shows all TypeScript/JavaScript files in the project

## After Running

Copy the entire output from the script and paste it here. I will then:
1. Analyze your design tokens (colors, fonts, spacing)
2. Understand your layout structure
3. Create a detailed architecture plan for the new project